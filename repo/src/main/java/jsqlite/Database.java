...
public class Database {
	 ...
	 *             ConnectionPoolManagerImpl.getSpatialiteConnection para
	 *             obtener las conexiones para evitar el error
	 *             jsqlite.Exception: E Spatialite: ERROR: Too many connections:
	 *             max 64
	 *             (https://groups.google.com/forum/#!topic/spatialite-users
	 *             /xrV7CA_GlwM)
	 */
	@Deprecated
	 ...
	 * @param type
	 *            return type code, e.g. jsqlite.Constants.SQLITE_NUMERIC
	 */
	...
	public static native void internal_init();
