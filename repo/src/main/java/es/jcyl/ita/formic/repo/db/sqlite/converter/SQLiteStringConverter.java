...
public class SQLiteStringConverter extends SQLitePropertyConverter {


    public SQLiteStringConverter(Class javaType) {
        super(SQLiteType.TEXT, javaType);
    }

    @Override
    public SQLiteDBValue doToPersistence(Object value) {
        return new SQLiteDBValue(SQLiteType.TEXT, value.toString());
    }
