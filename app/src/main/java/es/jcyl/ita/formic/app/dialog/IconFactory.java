...
public class IconFactory {
 ...
 private static final Map<String, Integer> iconInstances = new HashMap<String, Integer>();

 private IconFactory() {
  iconInstances.put("doc", es.jcyl.ita.formic.forms.R.drawable.ic_word);
  iconInstances.put("docx", es.jcyl.ita.formic.forms.R.drawable.ic_word);
  iconInstances.put("xls", es.jcyl.ita.formic.forms.R.drawable.ic_excel);
  iconInstances.put("xlsx", es.jcyl.ita.formic.forms.R.drawable.ic_excel);
