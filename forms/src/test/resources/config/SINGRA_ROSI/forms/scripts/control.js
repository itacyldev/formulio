    ...
    function setInspeccionadaInspeccion(c_accion_singra_id){
        ...
        /*if (
            entityInspeccion.get("d_firma_entidad") != null &&
            entityInspeccion.get("firma_entidad") != null) &&
            entityInspeccion.get("d_firma_t1") != null &&
            entityInspeccion.get("firma_t1") != null &&
            entityInspeccion.get("f_firma") != null){
            entityInspeccion.set("b_firmado",new java.lang.Long(1));
            inspeccionRepo.save(entityInspeccion);
        }*/
    }
    ...
    function todosInspeccion(c_accion_singra_view, valor){
        ...
        while(i != lstPmInspeccion.size()){
            ...
            if (c_accion_singra_bbdd == c_accion_singra_view){
                ...
                setRespuestaRespondida(entityPmInspeccion.get("c_cuestionario_respondido"), valor==1?'1':'0');
            }
            i++;
        }
