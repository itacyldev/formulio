...
public class OptionsConfig {
    ...
    private ValueBindingExpression labelExpression;
    ...
    public ValueBindingExpression getLabelExpression() {
        return labelExpression;
    }

    public void setLabelExpression(ValueBindingExpression labelExpression) {
