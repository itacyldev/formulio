...
import es.jcyl.ita.crtrepo.db.spatialite.meta.SpatialitePropertyType;
import es.jcyl.ita.crtrepo.db.sqlite.converter.SQLiteConverterFactory;
import es.jcyl.ita.crtrepo.db.spatialite.converter.SpatialiteBlobConverter;
...
public class SpatialiteMetaModelerTest {
    ...
    es.jcyl.ita.crtrepo.source.EntitySourceFactory sourceFactory = es.jcyl.ita.crtrepo.source.EntitySourceFactory.getInstance();
