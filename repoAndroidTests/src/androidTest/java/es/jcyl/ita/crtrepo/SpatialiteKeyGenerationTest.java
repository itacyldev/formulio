...
import es.jcyl.ita.crtrepo.db.meta.MaxRowIdKeyGenerator;
...
public class SpatialiteKeyGenerationTest {
    ...
    protected es.jcyl.ita.crtrepo.source.EntitySourceFactory sourceFactory = es.jcyl.ita.crtrepo.source.EntitySourceFactory.getInstance();
