package es.jcyl.ita.crtrepo.media;
...
import es.jcyl.ita.crtrepo.media.query.FileEntityExpression;
...
public class FileRepositoryTest {
    ...
    public void testInsertEntity() throws IOException {
        ...
        assertThat(fe.get("id"), CoreMatchers.notNullValue());
        assertThat(fe.get("absolutePath"), CoreMatchers.notNullValue());
        assertThat(fe.get("name"), CoreMatchers.notNullValue());
        assertThat(fe.get("size"), CoreMatchers.notNullValue());
    ...
    public void testUpdateEntity() throws IOException, InterruptedException {
        ...
        assertThat(nFile.lastModified(), Matchers.greaterThan(lastModified));
    }
