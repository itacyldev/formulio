...
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_METHOD;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_METHOD.CONTEXT;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_MOMENT;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_MOMENT.INSERT;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_MOMENT.SELECT;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.CALC_MOMENT.UPDATE;
import static es.jcyl.ita.crtrepo.db.meta.DBPropertyType.DBPropertyTypeBuilder;
