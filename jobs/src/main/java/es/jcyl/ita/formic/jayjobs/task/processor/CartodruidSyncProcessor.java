...
import es.jcyl.ita.crtsyn.core.exception.SynchronizationException;
import es.jcyl.ita.crtsyn.core.service.retrofit.RestException;
import es.jcyl.ita.crtsyn.core.service.retrofit.SyncCredentials;
import es.jcyl.ita.crtsyn.tasks.SyncClientTaskException;
...
import es.jcyl.ita.formic.jayjobs.utils.SyncUtils;

import static es.jcyl.ita.crtcyl.sync.service.SyncService.SyncStates.SYNC_FINISHED;
