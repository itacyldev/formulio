package es.jcyl.ita.formic.repo.config.meta;
/*
...
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.CONVERTER;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.DBFILE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.DBTABLE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.DEFAULT_EXTENSION;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.DESCRIPTION;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.ENTITYSELECTOR;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.FILTERING;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.FOLDER;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.FORCE_SELECTION;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.HEADER_TEXT;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.HEIGHT;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.ID;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.EMBEDDED;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.INPUT_TYPE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.LABEL;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.LABEL_EXPRESSION;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.LABEL_FILTERING_PROP;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.MAINFORM;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.NAME;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.NUM_VISIBLE_ROWS;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.ONSAVE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.ORDERING;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.PROPERTIES;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.READONLY;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.REGISTER_IN_HISTORY;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.RENDER;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.REPO;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.ROUTE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.TYPE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.VALIDATOR;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.VALUE;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.VALUE_PROPERTY;
import static es.jcyl.ita.formic.repo.config.meta.AttributeDef.WIDTH;
